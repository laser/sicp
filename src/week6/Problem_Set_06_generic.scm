...
;;;;  Used for Problem Set 6: Generic Operators
;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;;

;;; GENERIC ARITHMETIC OPERATIONS

;;;   GN = ({number} X RepNum) U ({rational} X RepRat)
;;;           U ({polynomial} X RepPoly)
...
(define (add-polynomial p1 p2)
  (make-polynomial (add-poly p1 p2)))


(define (mul-polynomial p1 p2)
  (make-polynomial (mul-poly p1 p2)))
